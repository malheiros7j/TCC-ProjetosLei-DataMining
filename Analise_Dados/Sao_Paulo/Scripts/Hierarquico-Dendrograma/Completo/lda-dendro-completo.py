...
cluster_geral = (cluster1 + cluster2 + cluster3 + cluster4 + cluster5 + cluster6 + cluster7 + cluster8 + cluster9 + cluster10 + cluster11 + cluster12)
# + cluster14 + cluster15 
...
clusterizacao = [cluster1, cluster2, cluster3, cluster4,cluster5, cluster6, cluster7, cluster8,cluster9, cluster10,cluster11, cluster12,cluster_geral]
