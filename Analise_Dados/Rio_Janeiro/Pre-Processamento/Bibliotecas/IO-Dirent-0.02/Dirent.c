 ...
 * contents of Dirent.xs. Do not edit this file, edit Dirent.xs instead.
 *
...
XS_EUPXS(XS_IO__Dirent_readdirent); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_IO__Dirent_readdirent)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "dirp");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	DIR *	dirp = IoDIRP(sv_2io(ST(0)))
;
	SV *	RETVAL;
#line 19 "Dirent.xs"
        Direntry_t      *dent;
...
extern "C"
#endif
XS_EXTERNAL(boot_IO__Dirent); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_IO__Dirent)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        (void)newXSproto_portable("IO::Dirent::readdirent", XS_IO__Dirent_readdirent, file, "*");
#if PERL_VERSION_LE(5, 21, 5)
