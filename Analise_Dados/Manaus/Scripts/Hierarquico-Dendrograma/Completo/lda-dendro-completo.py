...
z = linkage(date, method='complete', metric='euclidean')

# Dendrograma

dendrogram(z, truncate_mode="lastp", p=23, leaf_rotation=15., leaf_font_size=15., show_contracted=True)

plt.title("Dendrograma Clusterizacao Hierarquica Truncade")
...
cluster_geral = (cluster1 + cluster2 + cluster3 + cluster4 + cluster5 + cluster6 + cluster7 + cluster8 + cluster9 + cluster10 + cluster11 + cluster12 + cluster13 + cluster14 + cluster15 
